...
- `entity_id` (optional): Automatically set the uploaded image as this entity's reference and link it to `project_id`
...
When `entity_id` is supplied, the upload endpoint performs Option A automatically.

## Step 3: Apply the media_id manually
